...
After merging the data, it is saved each year in a separate file to make it easier to analyse the data by year. 
...
This graph shows the monthly number of accidents in New York in 2021, categorised by rainfall intensity.
