...
At this point we have two clean datasets, one with the vehicle crashes and the other with the weather data. 
Vehicle crashes are reduced considerably in size to about half the rows.
We will merge them into a single dataset to perform the analysis.
